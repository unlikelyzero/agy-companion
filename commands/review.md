...
- `/agy:review` does not support custom focus text.
...
- If the output later shows agy is blocked on Google OAuth login, tell the user to visit the printed URL and rerun the review — this plugin cannot complete an interactive login on your behalf.
